...
> "%DIST_DIR%\README.txt" (
  ...
  echo Lightweight Clients is not generated by default; use deploy\windows\app\package-light-clients.cmd only when a direct APK or Win7 handoff package is needed.
  echo.
  echo Tools:
